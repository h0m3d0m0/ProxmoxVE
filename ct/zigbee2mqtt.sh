...
function update_script() {
  ...
  if check_for_gh_release "Zigbee2MQTT" "Koenkk/zigbee2mqtt"; then
    NODE_VERSION=24 NODE_MODULE="pnpm@$(curl -fsSL https://raw.githubusercontent.com/h0m3d0m0/zigbee2mqtt/refs/heads/master/package.json | jq -r '.packageManager | split("@")[1]')" setup_nodejs
